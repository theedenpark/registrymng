...
<div class="container col-md-12">
    <div class="card p-4">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                ...
                <h4>Add New Property Account</h4>
            </div>
            <div class="px-3">
        ...
        <div class="myFormOverflow" style="border-top: 1px solid #ddd; display: none;">
            <form action="/addNewAcc" method="post" id="newAccForm" enctype="multipart/form-data">
                ...
                <div class="row m-0 py-4">
                    ...
                    <input type="text" value="1" name="user_type" style="display: none;">
                    <div class="col-md-3 mt-1">
                        <button class="btn btn-info btn-block shadow-none text-capitalize" id="addBtn" type="submit">Add New Property Account</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card my-4 p-4" style="overflow-x: auto !important;">
        <h4 class="pb-2">All Property Accounts</h4>
