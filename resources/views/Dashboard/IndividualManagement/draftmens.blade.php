...
<div class="container col-md-12">
    <div class="card p-4">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h4>Add New Draftmen Account</h4>
            </div>
            <div class="px-3">
            ...
            <form action="/addNewAcc" method="post" id="newAccForm" enctype="multipart/form-data">
                ...
                <div class="row m-0 py-4">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="formFields" placeholder="(Ex: Shyam S/O Ram)" name="username" required>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="">Mobile</label>
                        <input type="tel" class="formFields" name="mobile" required>
                    </div>
                    <div class="col-md-4 mb-3">
                    ...
                    <input type="text" value="6" name="user_type" style="display: none;">
                    <div class="col-md-3 mt-1">
                        <button class="btn btn-info btn-block shadow-none text-capitalize" id="addBtn" type="submit">Add New Draftmen Account</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card my-4 p-4" style="overflow-x: auto !important;">
        <h4 class="pb-2">All Draftmen's Accounts</h4>
