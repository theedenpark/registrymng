...
@section('title')
    Login - Registry Management | Ewen Realtors
@endsection

@section('body')
    <div class="row m-0 align-items-center">

        <div class="col-3 d-flex align-items-center bg-info text-light justify-content-center loginSidebar" style="height: 100vh;">
            <div>
        ...
        <div class="col-md-9 align-items-center p-5 row m-0 align-items-center bg-light loginForm" style="height: 100vh;">
            <div class="container col-md-6">
                <div class="card p-4 rounded-9">
                    ...
                    <h2 class="text-center text-info mt-1 mb-4">Registry Management Tool</h2>
                    ...
                    <form actionUrl="/login" method="post" id="loginForm">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mt-4">
                            <button class="btn btn-info btn-lg shadow-none" id="loginBtn">
