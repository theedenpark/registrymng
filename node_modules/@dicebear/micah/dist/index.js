...
const schema$1 = {
  ...
  "properties": {
    "eyeColor": {
      "description": "@deprecated use eyeShadow instead.",
...
const style = {
  ...
  create: _ref => {
    ...
    const colors = {
      ...
      'earring': pickColor(prng, 'earring', (_options$earringColor = options.earringColor) !== null && _options$earringColor !== void 0 ? _options$earringColor : []),
      'eyeShadow': pickColor(prng, 'eyeShadow', (_options$eyeShadowCol = options.eyeShadowColor) !== null && _options$eyeShadowCol !== void 0 ? _options$eyeShadowCol : []),
      'eyebrow': pickColor(prng, 'eyebrow', (_options$eyebrowColor = options.eyebrowColor) !== null && _options$eyebrowColor !== void 0 ? _options$eyebrowColor : []),
      'facialHair': pickColor(prng, 'facialHair', (_options$facialHairCo = options.facialHairColor) !== null && _options$facialHairCo !== void 0 ? _options$facialHairCo : []),
      ...
      'shirt': pickColor(prng, 'shirt', (_options$shirtColor = options.shirtColor) !== null && _options$shirtColor !== void 0 ? _options$shirtColor : [])
    };
    onPostCreate({
      prng,
      options,
